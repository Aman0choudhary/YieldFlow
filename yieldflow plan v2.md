...
**Source:** Converted from `PRD.md` (YieldFlow v2.1 execution-ready PRD)  
**Role:** Active product + delivery plan for the current repo  
**Status:** Active  
**Date:** 2026-07-21  

> This is the plan form of PRD v2. Scope authority remains aligned with `PRD.md`.  
> Companion tactical notes: `update.md`.
