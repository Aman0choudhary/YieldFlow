      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', borderBottom: '1px solid var(--grey-100)' }}>
          ...
          <button 
            ...
            onClick={() => alert('YieldFlow Soroban Contract Address: C...82K9')}
          >
            CONTRACT INFO
          </button>
        </div>
        ...
        >
          <div
            style={{
              ...
              boxShadow: '0 20px 80px rgba(45, 212, 168, 0.2)'
            }}
            onClick={(e) => e.stopPropagation()}
          >
            <span className="label" style={{ color: 'var(--theme-accent)' }}>WHAT YIELDFLOW IS ABOUT</span>
            <h2 style={{ marginTop: 'var(--spacer-12)', fontSize: '28px' }}>Real-Time Payroll + Automated Yield</h2>
            <p style={{ marginTop: 'var(--spacer-16)', color: 'var(--grey-300)' }}>
              YieldFlow eliminates treasury cash drag by routing committed payroll pools directly into Stellar money markets (DeFindex & Blend) on Soroban until the exact second employees stream their wages.
            </p>

            <div style={{ marginTop: 'var(--spacer-24)', display: 'flex', flexDirection: 'column', gap: 'var(--spacer-12)' }}>
              <div style={{ borderLeft: '2px solid var(--theme-accent)', paddingLeft: 'var(--spacer-12)' }}>
                <strong style={{ display: 'block', fontSize: '14px' }}>01 / Zero Idle Capital</strong>
              ...
              <div style={{ borderLeft: '2px solid var(--theme-accent)', paddingLeft: 'var(--spacer-12)' }}>
                <strong style={{ display: 'block', fontSize: '14px' }}>02 / Per-Second Streaming</strong>
              ...
              <div style={{ borderLeft: '2px solid var(--theme-accent)', paddingLeft: 'var(--spacer-12)' }}>
                <strong style={{ display: 'block', fontSize: '14px' }}>03 / Passkey Biometrics</strong>
